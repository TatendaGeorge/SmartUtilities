...
{
    public abstract class SmartUtilitiesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartUtilitiesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartUtilitiesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartUtilitiesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartUtilitiesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartUtilitiesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartUtilitiesDbContext, Task<T>> func)
        {
            T result;
